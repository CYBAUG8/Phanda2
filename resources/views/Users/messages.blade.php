...
<<<<<<< HEAD
    <h2>Messages</h2>
    <p>Your conversations with providers will appear here.</p>
@endsection
=======
            ...
            @foreach($groupedMessages as $date => $messages)
                ...
                @foreach($messages as $message)
                    ...
                    <div data-id="{{ $message->message_id }}"
                         ...
                         class="{{ $isUser ? 'flex justify-end' : 'flex items-start gap-2' }}">
                        <div class="{{ $isUser
                            ...
                            <div class="flex items-center gap-1 mt-1">
                                <span class="{{ $isUser ? 'text-xs text-orange-100' : 'text-xs text-gray-500' }}"
